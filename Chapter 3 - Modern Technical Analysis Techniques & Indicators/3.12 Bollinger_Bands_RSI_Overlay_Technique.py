...
from master_library import import_data, rsi, bollinger_bands, signal_chart_indicator

def bb_rsi_overlay(my_time_series, bb_lookback=20, num_std_dev=2):
    my_time_series = rsi(my_time_series, source='close', output_name='RSI', rsi_lookback=14)
    my_time_series = bollinger_bands(my_time_series, source='RSI', bb_lookback=bb_lookback, num_std_dev=num_std_dev)
...
# call the function(s)
my_time_series = bb_rsi_overlay(my_time_series, bb_lookback=20, num_std_dev=2)
# plot
signal_chart_indicator(my_time_series, 'RSI', window=250, plot_type='bars', barriers=False, indicator_label='RSI')
