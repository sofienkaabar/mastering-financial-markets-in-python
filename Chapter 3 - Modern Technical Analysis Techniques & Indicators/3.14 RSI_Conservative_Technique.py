...
def rsi_conservative_technique(my_time_series, column='close', output_name='RSI', 
...
# call the function(s)
my_time_series = rsi_conservative_technique(my_time_series)
# plot
signal_chart_indicator(my_time_series, indicator='RSI', window=240, lower_barrier=30, upper_barrier=70, plot_type='bars',
