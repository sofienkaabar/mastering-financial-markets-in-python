...
from master_library import import_data, ohlc_plot, red_indicator
...
def custom_signal_chart(my_time_series, window, choice='bars', source='open', chart_type='ohlc'): 
    ...
    bullish_signal = Line2D([0], [0], marker='^', color='w', label='Buy signal', markerfacecolor='red', markersize=10)
...
my_time_series = import_data('^RUT')
# call the function(s)
my_time_series = red_indicator(my_time_series)
# plot
custom_signal_chart(my_time_series, 1000)